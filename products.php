...
<?php  
  ...
  <h1><?php echo $row["name"]; ?></h1>  
   <h1>$ <?php echo $row["price"]; ?></h1>  <h1><span><b> Product Identification Num: </br> </span> <?php echo $row["id"]; ?></h1> 
...
<div class="container" style="background-color: grey; margin-top: -1400px;margin-right: -480px">  
...
<td><a class="btn btn-danger" style="margin-right: 500px"  href="index.php?action=delete&id=<?php echo $values["product_id"]; ?>">Remove</td>  </a> </tr>  
  <?php  
...
<h1>$ <?php echo number_format($total, 0); ?></h1>  
  ...
  <div class="container" style="margin-right: -480px; margin-top: -50px">
